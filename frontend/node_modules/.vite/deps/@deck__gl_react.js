...
import { B as deepEqual, Cn as defaultLogger, D as Widget, Dt as luma, E as Deck, F as GlobeViewport, O as applyStyles, P as LinearInterpolator, _ as Layer, n as FlyToInterpolator, s as OrthographicView, tt as WebMercatorViewport, z as View } from "./dist-y2hQLKSM.js";
...
var DeckGL = import_react.forwardRef(DeckGLWithRef), n, l$1, u$2, i$2, r$1, o$2, e$1, f$2, c$1, a$1, s$1, h$1, p$1, v$1, d$1 = {}, w$1 = [], _$1 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, g = Array.isArray;
function m$1(n, l) {
...
function normalizeAndClampAngle(angle) {
	...
	if (Math.abs(distanceFrom90) < AVOID_ANGLE_DELTA) {
		if (distanceFrom90 < AVOID_ANGLE_DELTA) normalized = 100;
		else if (distanceFrom90 > -10) normalized = 90 - AVOID_ANGLE_DELTA;
	}
	return normalized;
}
//#endregion
...
function computeScaleCandidate(metersPerPixel) {
	const minPixels = 100;
	const maxPixels = 200;
	const targetDistance = 300 / 2 * metersPerPixel;
